	...
	return (
		<div className="px-5 py-2 md:px-20 lg:px-80 lg:pt-5 flex flex-col dark:bg-[#121212] bg-white">
			<div className="mt-5 flex flex-col-reverse items-center justify-between md:flex-row">
				<div>
					...
					<p className="dark:text-white text-justify md:pr-10">
						...
						of the Computer Science from Indonesia Computer University.
						Interested in becoming a full-stack web developer and currently
					...
					<p className="dark:text-white text-justify mt-2 md:pr-10">
						...
						full-stack developer. Through my coursework, I&apos;ve gained
						hands-on experience with various programming languages, frameworks,
						and development tools. This knowledge is essential for building
			...
			<p className="mt-5 mb-10 dark:text-white">
				...
				<a
					className="font-bold"
					href="https://drive.google.com/file/d/1rUu7xzkQ1kisSwZ7G4caj8H8gBSbZ5dk/view?usp=sharing"
					target="_blank"
				>
					my resume here
				</a>
