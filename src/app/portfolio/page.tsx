	...
	return (
		<div className="px-5 pt-5 pb-20 md:px-20 lg:px-80 flex flex-col dark:bg-[#121212] bg-white">
			...
			<p className="dark:text-white">
				All the projects that I&apos;ve been created for quite some time
			</p>
			<div className="mt-10 md:grid md:grid-cols-2 md:gap-5">
				<div className="col-start-1 col-end-1">
					<Card className="h-[180px] mb-3 md:mb-0">
						...
						<CardContent>
							<p>
								Scrapping Data in Python and use that data to simulate GIS or
								Geographic Information System also using Python
							</p>
						</CardContent>
					</Card>
				</div>
				<div className="col-start-2 col-end-2">
					<Card className="h-[180px] mb-3 md:mb-0">
						<CardHeader>
							<CardTitle className="flex justify-between relative">
								...
								<div className="flex flex-row gap-5">
									...
									<Link href="https://repiyann.vercel.app/" target="_blank">
						...
						<CardContent>
							<p>
								My personal website, built with ReactJS, TailwindCSS,
								FontAwesome, and shadcn/ui components
							</p>
						</CardContent>
					</Card>
				</div>
				<div className="col-start-1 col-end-1">
					<Card className="h-[180px] mb-3 md:mb-0">
						...
						<CardContent>
							<p>
								A list of data science tasks featuring image recognition and
								random number generation projects
							</p>
						</CardContent>
					</Card>
				</div>
					...
					<Card className="h-[180px] mb-3 md:mb-0">
						<CardHeader>
							<CardTitle className="flex justify-between relative">
								...
								<div className="flex flex-row gap-5">
									<Link
										href="https://github.com/repiyann/iitc-2024-web-design"
										target="_blank"
									>
										<Github className="hover:text-[#264480]" />
									</Link>
									<Link href="https://eduverse.ekel.dev/" target="_blank">
										<ExternalLink className="hover:text-[#264480]" />
									</Link>
								</div>
							</CardTitle>
						...
						<CardContent>
							<p>
								A clean, responsive design for educational websites, created for
								the IITC 2024 competition
							</p>
						</CardContent>
					</Card>
				</div>
